...
import com.k1fl1k.dbpractice.persistance.service.validation.ToysValidation;
import com.k1fl1k.dbpractice.persistance.service.validation.UsersValidation;
...
public class ToysDAO {
    ...
    private static final ToysDAO instance = new ToysDAO();
    ...
    public static ToysDAO getInstance() {
        return instance;
    }
    ...
    public void addToy(Toys toy) {
        ToysValidation toysValidation = new ToysValidation()
            .type(toy.getType())
            .value(toy.getValue())
            .price(toy.getPrice())
